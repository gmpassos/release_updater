...
final pack_path.Context contextWindows = pack_path.Context(
  style: pack_path.Style.windows,
);
final pack_path.Context contextPosix = pack_path.Context(
...
void main() {
  group('Utils', () {
    ...
    test('splitPathRootPrefix', () async {
      expect(
        splitPathRootPrefix('/foo/bar/baz.txt'),
        equals([pack_path.separator, 'foo/bar/baz.txt']),
      );

      expect(
        splitPathRootPrefix('/foo/bar/baz.txt', asPosix: true),
        equals(['/', 'foo/bar/baz.txt']),
      );

      expect(
        splitPathRootPrefix('/foo/bar/baz.txt', asWindows: true),
        equals(['\\', 'foo/bar/baz.txt']),
      );
      ...
      expect(
        splitPathRootPrefix('/foo/bar/baz.txt', pathContext: contextPosix),
        equals(['/', 'foo/bar/baz.txt']),
      );
    ...
    test('normalizePlatformPath', () async {
      expect(
        normalizePlatformPath('/foo/bar/baz.txt', separator: '/'),
        equals('/foo/bar/baz.txt'),
      );
      ...
      expect(
        normalizePlatformPath(
          'https://localhost/foo/bar/baz.txt',
          separator: '/',
        ),
      ...
      expect(
        normalizePlatformPath(
          'file://localhost/foo/bar/baz.txt',
          separator: '/',
        ),
      ...
      expect(
        normalizePlatformPath('file:///foo/bar/baz.txt', separator: '/'),
        equals('/foo/bar/baz.txt'),
      );
      ...
      expect(
        normalizePlatformPath('C:/foo/bar/baz.txt', separator: '\\'),
        equals('C:\\foo\\bar\\baz.txt'),
      );
